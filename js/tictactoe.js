...
function placeXoro(squareNumber)    {
    ...
    //The .some() method is used to check each element of selectedSquare array to see if it contains the square number click on
    if (!selectSquares.some(Element => Element.includes(squareNumber))) {
        ...
        if(activeplayer === 'O')    {
            ...
            //This function waits 1 second before placing the iamge and enabling click
...
function checkWinConditions()   {
    ...
    // X 0, 3, 6 condition.
    else if (arrayIncludes('0X', '3X', '6X'))   { drawWinLine(100, 50, 304, 558); }
    // X 1, 4, 7 condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2)    {
    ...
    let x1 = coordX1,
        //This line inidicates where the end of a line y axis is.
        y1 = coordY1,
    ...
    function animateLineDrawing()   {
        ...
        c.strokeStyle = 'rgba(0, 238, 255, 0.8)';
        ...
        if (x1 <= x2 && y1 <= y2)   {
            ...
            if (y < y2) { y += 10; }
            //This condition cancels our animation loop if reached the end points.
